...
public class IsisScrapeGui {
    private IsisScrape guiIsisScrape;
    Lecture lect;
	...
	switch (theOption) {
	case 1:	optionList = guiIsisScrape.getDeptOptions();
	    guiIsisScrape.setDept(optionList.get(0));
	    break;
	case 2:	optionList = guiIsisScrape.getQuarterOptions();
	    guiIsisScrape.setQuarter(optionList.get(0));
	    break;
	case 3:	optionList = guiIsisScrape.getGradLevelOptions();
	    guiIsisScrape.setGradLevel(optionList.get(0));
	    break;
	case 4:	optionList = guiIsisScrape.getCourseOptions();
	    guiIsisScrape.setCourse(optionList.get(0));
	    break;
	...
	public void actionPerformed(ActionEvent e) {
	    ...
	    guiIsisScrape.setDept(optionSelect);
	...
	public void actionPerformed(ActionEvent e) {
	    @SuppressWarnings("unchecked")
		String optionSelect = (String) ((JComboBox<String>)e.getSource()).getSelectedItem();
	    guiIsisScrape.setQuarter(optionSelect);
	...
	public void actionPerformed(ActionEvent e) {
	    @SuppressWarnings("unchecked")
		String optionSelect = (String) ((JComboBox<String>)e.getSource()).getSelectedItem();
	    guiIsisScrape.setGradLevel(optionSelect);
	...
	public void actionPerformed(ActionEvent e) {
	    @SuppressWarnings("unchecked")
		String optionSelect = (String) ((JComboBox<String>)e.getSource()).getSelectedItem();
	    guiIsisScrape.setCourse(optionSelect);
	}
    }
	...
	@Override
	public void actionPerformed(ActionEvent e) {
	    boolean finish = guiIsisScrape.setLecture();
			
	    if (finish) {
		lect = guiIsisScrape.getLecture();
